...
test('Verify the add employee', async ({ page }) => {
  ...
  await page.locator("//div[@class='oxd-input-group oxd-input-field-bottom-space']//div//input[@class='oxd-input oxd-input--active']").fill("madanapallishdouahfhadfhahfagofafofoufwoffnadfjnfqenfqenggrognrwgwogo")
